...
/**
 * Sincroniza las métricas de una publicación hacia el snapshot del día.
 * Reintentable; el proveedor sin configurar se omite sin fallar.
 */
class SyncPostMetrics implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        return [(new WithoutOverlapping('sync-post-' . $this->targetId))->dontRelease()];
    }
